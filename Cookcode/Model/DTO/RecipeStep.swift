...
struct RecipeStep: Codable, Hashable, Identifiable {
    ...
    static let MOCK_DATA: RecipeStep = RecipeStep(stepID: 1, seq: 1, title: "레시피", description: "설명", photos: [ImageContent.MOCK_DATA1, ImageContent.MOCK_DATA2], videos: [])
    
    static let MOCK_DATA2: RecipeStep = RecipeStep(stepID: 2, seq: 1, title: "레시피", description: "설명", photos: [ImageContent.MOCK_DATA3], videos: [])
